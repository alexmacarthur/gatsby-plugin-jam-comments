...
!(function(e, n) {
  ...
  function t(e, n, t, r, a, o, i) {
    ...
    m.done ? n(c) : Promise.resolve(c).then(r, a);
  }
  function r(e) {
    return function() {
      var n = this,
            ...
            switch ((e.prev = e.next)) {
              case 0:
                return (
                  ...
                  (o = void 0 === a ? {} : a),
                  (e.next = 3),
                  fetch("https://service.jamcomments.com/graphql", {
                    method: "POST",
                    headers: {
                      "Content-Type": "application/json",
                      "x-api-key": t
                    },
                    body: JSON.stringify({ query: r, variables: o })
                  })
                );
              case 3:
  ...
  var d = ({ styles: e = {}, ...t }) =>
    ...
    p = process.env.GATSBY_JAM_COMMENTS_API_KEY,
    f = process.env.GATSBY_JAM_COMMENTS_DOMAIN,
    g = function() {
    ...
    v = function(t) {
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          b(!0),
                          (C = c.current),
                          (r = o(C.elements).reduce(function(e, n) {
                      ...
                      case 12:
                        if (
                          ...
                          !(null === (h = v) || void 0 === h
                            ? void 0
                            : h.errors) || !v.errors.length)
                        ) {
                          e.next = 17;
                          break;
                        }
                        return (
                          console.log(v.errors[0].message),
      ...
      return n.createElement(
        ...
        v &&
          n.createElement(
            "div",
            { className: "jc-CommentBox-loadingDots" },
            n.createElement(d, null)
          ),
        n.createElement(
          "div",
          {
            className: "jc-CommentBox-inputs ".concat(v ? "is-submitting" : "")
          },
          n.createElement("h3", null, "Leave a Comment"),
          j && n.createElement(l, null, j),
          n.createElement(
            "form",
            { onSubmit: S, ref: c, className: "jc-CommentBox-form" },
            n.createElement(
              "label",
              ...
              n.createElement(
                "small",
                { className: "jc-CommentBox-attribution" },
                "Powered by ",
                n.createElement(
                  "a",
                  {
          ...
          n.createElement(
            ...
            n.createElement(
              "time",
              {
                ...
                dateTime: ((r = a.createdAt), b(r).toISOString())
              },
              (function(e) {
                var n = b(e),
