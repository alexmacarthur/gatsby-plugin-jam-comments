(function (global, factory) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _ref2 = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, apiKey = _ref2.apiKey, domain = _ref2.domain, query = _ref2.query, _ref2$variables = _ref2.variables, variables = _ref2$variables === void 0 ? {} : _ref2$variables;
              _context.next = 3;
  ...
  var formInputsToValues = (function (formElement) {
    return _toConsumableArray(formElement.elements).reduce(function (obj, input) {
  ...
  var CommentBox = (function (_ref) {
    ...
    var _useState = React.useState(""),
        ...
        formSuccessMessage = _useState2[0],
        setFormSuccess = _useState2[1];

    var _useState3 = React.useState(""),
        _useState4 = _slicedToArray(_useState3, 2),
        formErrorMessage = _useState4[0],
        setFormError = _useState4[1];

    var _useState5 = React.useState(false),
        _useState6 = _slicedToArray(_useState5, 2),
        shouldShowFullForm = _useState6[0],
        setShouldShowFullForm = _useState6[1];

    var submitComment = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
        var mutationParams, query, name, content, emailAddress, variables, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                setFormError("");
                setFormSuccess("");
                mutationParams = formInputsToValues(formRef.current);
                ...
                name = mutationParams.name, content = mutationParams.content, emailAddress = mutationParams.emailAddress;
                variables = {
                  name: name,
                  content: content,
              ...
              case 10:
                ...
                return _context.abrupt("return", newComment(response.data.createComment));
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, formSuccessMessage && /*#__PURE__*/React__default.createElement(Message, {
      isSuccessful: true
    }, formSuccessMessage), formErrorMessage && /*#__PURE__*/React__default.createElement(Message, null, formErrorMessage), /*#__PURE__*/React__default.createElement("h3", null, "Leave a Comment"), /*#__PURE__*/React__default.createElement("form", {
      ...
      required: true,
      onFocus: function onFocus() {
        return !shouldShowFullForm && setShouldShowFullForm(true);
      }
    })), shouldShowFullForm && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("label", {
  ...
  var Comment = (function (_ref) {
    ...
    }, comment.name), /*#__PURE__*/React__default.createElement("a", {
    ...
    }, toPrettyDate(comment.createdAt)))), /*#__PURE__*/React__default.createElement("div", {
  ...
  var CommentList = (function (_ref) {
    ...
    }, comments.length, " ", pluralize(comments, "comment")), /*#__PURE__*/React__default.createElement("ul", {
  ...
  var css_248z$4 = ".jc-Shell {\n  --jc-red: #BA274A;\n  --jc-green: #5BBA6F;\n  --jc-gray: #dfdede;\n  --jc-gray-dark: #5c5c5c;\n  --border-radius: 5px;\n  margin: 2rem 0; }\n";
  styleInject(css_248z$4);

  var index = (function (_ref) {
    var pageContext = _ref.pageContext;
    var initialComments = pageContext && pageContext.comments ? pageContext.comments : [];
